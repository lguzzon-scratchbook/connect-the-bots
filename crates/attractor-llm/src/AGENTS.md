...
Multi-provider LLM client abstraction. Unifies Anthropic, OpenAI, Google Gemini APIs under common `Request`/`Response` types. Supports middleware hooks, provider auto-detection from environment, and type-erased provider collections.
